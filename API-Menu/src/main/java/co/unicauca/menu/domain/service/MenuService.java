...
public class MenuService {
    ...
    private List<Error> validateUpdate(String idMenu, Menu newMenu) {
        ...
        if (userAux == null) {
            ...
            errors.add(error);
        } else if (repository.findByIdRest(newMenu.getAtrIdRest()).isEmpty() || repository.findByIdRest(newMenu.getAtrIdRest()) == null) {
            //El restaurante no existe 
            Error error = new Error(ValidationError.INVALID_FIELD, "idMenu", "El id del restaurante no existe");
            errors.add(error);
        }
    ...
    public boolean deletePlato(String idMenu, String plato) {
        List<Error> errors = validarCamposOfrece(idMenu, plato);
        ...
        // Pasada la validación, se puede borrar de la bd
        return repository.deletePlato(idMenu, plato);
