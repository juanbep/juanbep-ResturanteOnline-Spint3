...
public class RestauranteController {
    ...
    */
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X GET http://localhost:8084/API-Restaurante/restaurante-service/restaurante/findByName/Dominos
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X GET http://localhost:8084/API-Restaurante/restaurante-service/restaurante/findByNit/100
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X GET http://localhost:8084/API-Restaurante/restaurante-service/restaurante/findByAdmin/axquijano
